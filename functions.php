...
function restimo_fonts_url() {
	...
	if ( !isset( $second_font['font-family'] ) || $second_font['font-family'] == '' ) {
		$font_families[] = 'Merriweather:300,400,500,600,700,700i';
	}
...
function restimo_scripts() {
	...
	wp_enqueue_script( 'tcg-cursor-smoke-js', get_template_directory_uri() . '/js/smoke68b3.js', array( 'jquery' ), '20200716', true );
