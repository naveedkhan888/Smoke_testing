 ...
 */
class Restimo_Image_Box_2 extends Widget_Base{
	...
	public function get_title() {
		return __( 'XP Image Box 2', 'restimo' );
	}
		...
		<div class="xp-image-box">
			...
			<div class="content-box">
				<?php if ( $settings['title'] ) { 
				    echo '<i class="xp-webicon-trajectory"></i> ' . wp_kses_post( $title_html ); 
				} ?>
				<?php if( $settings['des'] ) { echo '<p>' .$settings['des']. '</p>'; } ?>
			</div>
			<?php if( $settings['label_link'] ){ echo '<a ' .$this->get_render_attribute_string( 'button' ). '><span>' .$settings['label_link']. '</span></a>'; } ?>
	    </div>
...
// After the Restimo_Image_Box_2 class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new Restimo_Image_Box_2() );